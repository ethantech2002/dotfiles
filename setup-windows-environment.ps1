...
if (Test-Path $terminalSettingsPath) {
    ...
    $settings.profiles.defaults | Add-Member -MemberType NoteProperty -Name "cursorShape" -Value "filledBox" -Force
    
    # Set history size
    $settings.profiles.defaults | Add-Member -MemberType NoteProperty -Name "historySize" -Value 12000 -Force
    
    # Set intense text style
    $settings.profiles.defaults | Add-Member -MemberType NoteProperty -Name "intenseTextStyle" -Value "bright" -Force
    ...
    # Set padding
    $settings.profiles.defaults | Add-Member -MemberType NoteProperty -Name "padding" -Value "8" -Force
